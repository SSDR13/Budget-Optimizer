...
export default function Login() {
    ...
    return (
        <div className="min-h-screen gradient-bg flex items-center justify-center p-4">
            {/* Background effects */}
            <div className="absolute top-1/4 left-1/3 w-72 h-72 bg-brand-600/20 rounded-full blur-3xl" />
            <div className="absolute bottom-1/4 right-1/3 w-64 h-64 bg-accent-cyan/10 rounded-full blur-3xl" />
