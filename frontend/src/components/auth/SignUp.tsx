...
export default function SignUp() {
    ...
    return (
        <div className="min-h-screen gradient-bg flex items-center justify-center p-4">
            <div className="absolute top-1/4 right-1/3 w-72 h-72 bg-accent-violet/15 rounded-full blur-3xl" />
            <div className="absolute bottom-1/3 left-1/4 w-64 h-64 bg-brand-600/15 rounded-full blur-3xl" />
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="glass-card p-8">
                    ...
                    <p className="text-surface-400 mb-6">Start optimizing your finances with AI</p>
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-3 bg-surface-800/50 text-surface-500">or</span>
                        </div>
                    </div>
